...
func (e Encrypted) CopyTo(name string, w io.Writer) error {
	return e.F.CopyTo(name, CipherWriter(e.B,w))
}

func (e Encrypted) CopyFrom(name string, r io.Reader) error {
	return e.F.CopyFrom(name, CipherReader(e.B, r))
}
